 ...
 * @author r212
 */
public class BossBattleScreen extends AbstractScreen implements BattleEventPlayer {
    ...
    public BossBattleScreen(PokemonGame app) {
        super(app);
        ...
        Texture magearna = app.getAssetManager().get("res/graphics/pokemon/magearna.png", Texture.class);
        Texture magnezone = app.getAssetManager().get("res/graphics/pokemon/magnezone.png", Texture.class);


        Trainer playerTrainer = BattleScreen.playerTrainer;

        opponentTrainer = new Trainer(Pokemon.generatePokemon("Kiyoi's Magearna", magearna, app.getMoveDatabase(), 10));
        opponentTrainer.addPokemon(Pokemon.generatePokemon("Kiyoi's Magnezone ", magnezone, app.getMoveDatabase(), 10));
